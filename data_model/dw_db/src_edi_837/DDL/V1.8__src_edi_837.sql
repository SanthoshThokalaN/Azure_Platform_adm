...
CREATE OR REPLACE PROCEDURE "SP_LEGACY_PROF_PATIENT" 
(
...
COALESCE(MD5(PRV.GRP_CONTROL_NO||PRV.TRANCACTSET_CNTL_NO||PRV.TRANSACTSET_CREATE_DATE||CLM.CLAIM_ID), MD5('999999999'))   AS XML_MD5,
...
CREATE OR REPLACE PROCEDURE "SP_LEGACY_PROF_SUBSCRIBER" 
(
...
CREATE OR REPLACE PROCEDURE "SP_LEGACY_PROF_PROVIDER" 
(
...
CREATE OR REPLACE PROCEDURE "SP_LEGACY_PROF_PAYER" 
(
