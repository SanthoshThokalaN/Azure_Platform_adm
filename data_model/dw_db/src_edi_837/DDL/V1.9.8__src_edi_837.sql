...
CREATE OR REPLACE PROCEDURE SP_LEGACY_PROF_CLM_SV_DATES("PIPELINE_ID" VARCHAR(16777216), "PIPELINE_NAME" VARCHAR(16777216), "TRAN_MTH" VARCHAR(16777216), "DB_NAME" VARCHAR(16777216), "UTIL_SC" VARCHAR(16777216), "SRC_SC" VARCHAR(16777216), "TGT_SC" VARCHAR(16777216), "WH" VARCHAR(16777216), "STAGE" VARCHAR(16777216))
...
V_SUB_PROCESS_NAME  VARCHAR DEFAULT  ''LEGACY_PROF_CLM_SV_DATES'';
...
V_TEMP_TBL  VARCHAR :=  :SRC_SC||''.''||''TMP_PROF_CLM_SV_DATES_RAW''||''_''||:TRAN_MTH;

V_LZ_TBL    VARCHAR :=  :SRC_SC||''.''||''PROF_CLM_SV_DATES_RAW'';

V_SRC_TBL   VARCHAR :=  :TGT_SC||''.''||''PROF_CLM_SV_DATES'';
