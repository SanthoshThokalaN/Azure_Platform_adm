...
CREATE TABLE IF NOT EXISTS LZ_EDI_837.PROF_CLAIM_CLMNBR_ERROR AS SELECT * EXCLUDE (ISDC_CREATED_DT, ISDC_UPDATED_DT) FROM SRC_EDI_837.PROF_CLAIM_CLMNBR WHERE 1 = 2;
