...
V_SUB_PROCESS_NAME VARCHAR DEFAULT ''PROF_SUBMITTER_NAME'';
...
V_PROF_SUBMITTER_NAME VARCHAR := :DB_NAME||''.''||COALESCE(:TGT_SC, ''SRC_EDI_837'')||''.PROF_SUBMITTER_NAME'';
...
ALTER SESSION SET TIMEZONE = ''America/Chicago'';
   ...
   V_STEP_NAME := ''LOAD PROF_SUBMITTER_NAME'';
...
INSERT INTO IDENTIFIER(:V_PROF_SUBMITTER_NAME)
...
SELECT * FROM TEMP WHERE NOT EXISTS (SELECT 1 FROM IDENTIFIER(:V_PROF_SUBMITTER_NAME) P WHERE P.XML_HDR_MD5 = TEMP.XML_HDR_MD5)
